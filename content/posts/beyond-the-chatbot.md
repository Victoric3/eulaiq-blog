...
{{< comparison-grid >}}
  {{< comparison-card
      ...
      icon="text_snippet"
      description="Static blocks of text that require high mental effort to visualize."
      color="#f44336" >}}
  {{< comparison-card
      title="AI Lesson Teacher"
      icon="play_circle"
      description="Dynamic animations that show you exactly how things work as they happen."
      color="#4caf50" >}}
{{< /comparison-grid >}}
...
{{< feature-grid >}}
    {{< feature-item icon="touch_app" title="Don't just watch" description="Interrupt the lesson at any point to clarify what you see." >}}
    {{< feature-item icon="ads_click" title="Point and Ask" description="Interaction that goes beyond the keyboard. Focus on exactly what matters." >}}
    {{< feature-item icon="psychology" title="Visual Intuition" description="Concepts are built visually, so they actually stick in your long-term memory." >}}
{{< /feature-grid >}}
